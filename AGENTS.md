# AI Agent Instructions: FFC-IN-Single_Page_Template_Jekell
...
These sites deploy to `https://freeforcharity.github.io/FFC-IN-Single_Page_Template_Jekell/` and optionally to a custom domain if one is configured for this repo.
